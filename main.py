...
async def payment_success(request: Request):
    ...
    wa_link = f"https://wa.me/{WHATSAPP_BUSINESS_PHONE}?text=Hi"
    return HTMLResponse(f"""<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Payment Successful — Main Mission</title>
<style>
...
.card{{background:#1a1d27;border:1px solid #2a2d3a;border-radius:16px;padding:40px 32px;max-width:480px;width:100%;text-align:center}}
.tick{{font-size:56px;margin-bottom:16px}}
...
.wa-btn{{display:inline-flex;align-items:center;gap:10px;background:#25d366;color:#fff;text-decoration:none;border-radius:10px;padding:14px 28px;font-size:16px;font-weight:700;margin-bottom:12px}}
...
<div class="card">
  ...
  <p>Welcome to Main Mission! Your coaching programme is ready.<br>
  Click below to start a WhatsApp chat with your AI coach — just send <strong>Hi</strong> to get started.</p>
  <a class="wa-btn" href="{wa_link}" target="_blank">
    ...
    Chat with your coach on WhatsApp
  </a>
  <p class="hint">You'll be redirected to WhatsApp. Just tap Send on the "Hi" message.</p>
</div>
</body>
</html>""")
