...
async def api_media_proxy(url: str):
    """Proxy Wati image URLs so the dashboard can display them without exposing the API token."""
    ...
    try:
        ...
        logger.error(f"Media proxy failed for {url}: {e}")
